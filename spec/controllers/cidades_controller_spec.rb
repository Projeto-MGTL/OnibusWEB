  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cidade as @cidade" do
        ...
        post :create, {:cidade => { "nome" => "invalid value" }}, valid_session
        assigns(:cidade).should be_a_new(Cidade)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cidade" do
        ...
        Cidade.any_instance.should_receive(:update_attributes).with({ "nome" => "MyString" })
        put :update, {:id => cidade.to_param, :cidade => { "nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the cidade as @cidade" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Cidade.any_instance.stub(:save).and_return(false)
        put :update, {:id => cidade.to_param, :cidade => { "nome" => "invalid value" }}, valid_session
        assigns(:cidade).should eq(cidade)
      end
